...
# (do not include the source folder in the name)
COMPONENT_FILES	:= memory_control.sv mux.sv pc.sv ram.sv register_file.sv request_unit.sv request.sv ru_ram.sv signExtender.sv writeToReg.sv control.sv alu.sv
