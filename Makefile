...
TOP     = $(MODULE).sv
SRC 	= ./src/$(TOP) ./src/alu.sv ./src/control.sv ./src/mux.sv ./src/pc.sv ./src/ram.sv ./src/register_file.sv ./src/signExtender.sv ./src/writeToReg.sv ./src/ru_ram.sv ./src/request.sv ./src/request_unit.sv ./src/memory_control.sv
TB		= ./tb/tb_$(MODULE).sv
# SRC 	= ./src/$(TOP)
ICE     = ice40hx8k.sv
